<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteMaster.Master" Inherits="System.Web.Mvc.ViewPage<KMI_INTRANET.Models.News>" %>
    ...
    <% using (Html.BeginForm())
       {%>
        ...
        <fieldset style="width:70%;">
             <div><%= Html.HiddenFor(model => model.idnews)%></div>
            ...
            <div class="input-group" style="margin-left:10px;">
                <%= @Html.TextBox("NewsFile", Model.NewsFile, new { style = "width: 200px;", type = "file" })%><p style="color:Blue;">Keep Empty If Not Change Nickname</p>
