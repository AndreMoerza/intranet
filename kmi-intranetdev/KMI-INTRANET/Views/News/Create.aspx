<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteMaster.Master" Inherits="System.Web.Mvc.ViewPage<KMI_INTRANET.Models.CreateNews>" %>
...
<script src="<%=Url.Content("~/Scripts/jquery.validate.unobtrusive.min.js")%>" type="text/javascript"></script>
    ...
    <fieldset style="width:70%;">
            ...
            <div class="editor-label">
                <%=@Html.LabelFor(m => m.NewsFile)%>
            </div>
            <div class="input-group" style="margin-left:10px;">
                <%= @Html.TextBoxFor(m => m.NewsFile, new { Style = "width:200px;", type = "file" })%>
                <%= @Html.ValidationMessageFor(m => m.NewsFile)%> 
            </div>
            <div class="editor-label">
