...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="box" style="width: 90%;padding-left:5px;">
                                ...
                                <p>
                                 <%: @Html.ActionLink("Tambah Form", "Create", null, new { @class = "btn btn-instagram" })%>
                                </p>
                                              ...
                                              { %>
                                                   <tr> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <%: @Html.ActionLink("Ubah", "Edit", new { id = item.idform })%> |
                                                        <%: @Html.ActionLink("Hapus", "Delete", new { id = item.idform })%>
                                                   </td>
                                                   </tr>
                                            <% } %>
                                        </tbody>
